...
let readyToProducePublisher = Publishers.CombineLatest(orderStatusPublisher,
...
NotificationCenter.default.post(name: .didValidateAddress, object: margheritaOrder,
